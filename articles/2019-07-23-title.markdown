---
layout: post
title: "Authorization Series - Pt 3: Dynamic Authorization with GraphQL and Rules"
description: "In this article we're going to build a quidditch management system using Flask and GraphQL. We'll then look at how we can use this graph-structured data to implement an attribute based authorization model and a graph based authorization model using Auth0 rules."
...
>Editor's Note: This is the third and final technical post in a 3-part series on focusing on Authorization. If you'd like two read the previous to (not mandatory to follow this article), you can find them below.
...
![](images/graphql-players-query.png)
...
Make sure you checkout the previous articles in our **Authorization series** below:

[Authorization Series - Pt 1: What is Authorization?](https://auth0.com/blog/authorization-series-pt-1-what-is-authorization/)

[Authorization Series - Pt 2: Securing HTTP APIs with RBAC rules](https://auth0.com/blog/authorization-series-pt-2-securing-http-apis-with-rbac-rules/) 

Authorization Series - Pt 3: Dynamic Authorization with GraphQL and Rules -- (You are here)